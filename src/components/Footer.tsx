...
const Footer = () => {
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "DriveOps",
    "image": "https://driveops.info.chatserve.in/logo/driveops-logo-blue-edited.png",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a
                  href="mailto:driveopsfleet@gmail.com"
                  className="flex items-start gap-3 group"
                ...
                >
                  ...
                  <div>
                    <span className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider block mb-0.5">Support</span>
                    <span className="text-sm text-slate-300 group-hover:text-white transition-colors font-medium break-all">driveopsfleet@gmail.com</span>
                  </div>
                </a>
              </li>
              <li>
